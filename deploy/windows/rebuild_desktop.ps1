# Rebuild AiCan Desktop v5.2 and relaunch.
...
Write-Host "=== AiCan Desktop v5.2 rebuild ===" -ForegroundColor Cyan
...
Write-Host "=== Done - AiCan Desktop v5.2 launched ===" -ForegroundColor Green
